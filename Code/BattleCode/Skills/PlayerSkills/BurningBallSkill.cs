...
// {
//     public class BurningBallSkill : BaseSkill, IAttackSkill, IBuffOrDeBuffSkill
//     {
...
//                 $"체이닝 효과로 {SkillData.visualData.uiName}의 범위가 2로 증가했습니다.",
//                 SystemLogOwner.Player
//             ));
//
//             actions.Add(new SkillRangeChangeAction(SkillData, 2));
//
...
//
//                 newTargets = SkillTargetingUtil.GetTargetsByRange(enemies, centerIndex, 2, true);
