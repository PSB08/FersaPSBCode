...
// Chain: PlayEffectCallbackAction -> DamageSkillAction
//
...
// {
//     public class SpinAttackSkill : BaseSkill, IAttackSkill, IEnchantable
//     {
...
//             List<ISkillAction> actions = new List<ISkillAction>();
//
//             DamageData damageData = new DamageData(SkillData.damage * 2, CurrentElementalState.CurrentElemental);
//
//             actions.Add(new PlayEffectCallbackAction(this, targets));
//             actions.Add(new DamageSkillAction(user, targets, damageData, SkillData.impulsePower));
//             UseAttackSkill();
