...
// Chain: SystemLogSkillAction -> SkillRangeChangeAction -> PlayEffectCallbackAction -> BuffSkillAction -> DamageSkillAction -> SkillRangeRevertAction
//
...
// {
//     public class FlameCascadeSkill : BaseSkill, IAttackSkill, IBuffOrDeBuffSkill
//     {
...
//                 $"체이닝 효과로 {SkillData.visualData.uiName}의 범위가 5로 증가했습니다.",
//                 SystemLogOwner.Player
//             ));
//
//             actions.Add(new SkillRangeChangeAction(SkillData, 5));
//
...
//
//                 newTargets = SkillTargetingUtil.GetTargetsByRange(enemies, centerIndex, 5, true);
//             }
//
//             actions.Add(new PlayEffectCallbackAction(this, newTargets));
//             actions.Add(new BuffSkillAction(user, BuffType.FLAME_DEBUFF, 5, SkillData.durationTurn));
//
//             DamageData normalDamage = new DamageData(SkillData.damage, CurrentElementalState.CurrentElemental);
